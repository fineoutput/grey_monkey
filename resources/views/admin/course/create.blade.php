                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 my-3" style="margin-top: 23px!important">
                                        <select name="type" id="type" class="form-control">
                                            ...
                                            <option value="UG" @if (!empty($data->type) && ($data->type == 'UG')) selected @endif>UG</option>
                                            <option value="PG" @if (!empty($data->type) && ($data->type == 'PG')) selected @endif>PG</option>
                                        </select>
                                        @error('type')
                                    ...
                                    <div class="col-sm-6 my-3" style="margin-top: 23px!important">
                                        <select name="duration" id="duration" class="form-control">
                                            ...
                                            <option value="1" @if (!empty($data->duration) && ($data->duration == '1')) selected @endif>1 Year</option>
                                            <option value="2" @if (!empty($data->duration) && ($data->duration == '2')) selected @endif>2 Year</option>
                                            <option value="3" @if (!empty($data->duration) && ($data->duration == '3')) selected @endif>3 Year</option>
                                        </select>
                                        @error('duration')
                                        <span class='invalid-feedback' role='alert' style='color:#dc3545 !important'>
                                            <strong>{{ $message }}</strong>

                    ...
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2"> <a class="btn btn-info cticket" href="{{route('courses.create')}}" role="button" style="margin-left: 20px;"> Add {{$title}}</a></div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" id="btns{{$loop->iteration}}">
                                                        <a href="{{route('courses.edit',base64_encode($data->id))}}"><i class="fas fa-pencil-alt info-icon" data-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                                    ...
                                                    <div style="display:none" id="cnfbox{{$loop->iteration}}">
                                                        ...
                                                        <a href="{{route('courses.destroy',base64_encode($data->id))}}" class="btn btn-danger">Yes</a>

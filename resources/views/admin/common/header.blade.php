...
<head>
    ...
    <style>
        ...
        .enlarged #wrapper .left.side-menu #sidebar-menu>ul>li>a i.fa.fa-search.metismenu-3 {
        ...
        .enlarged #wrapper .left.side-menu #sidebar-menu ul>li:hover a span.main-boxx {
    ...
    margin-right: 11px !important;
        ...
        .app-search .form_control:focus {
            border: 1px solid #f0676b;
            font-size: 13px;
            height: 34px;
            padding-left: 18px;
            padding-right: 40px;

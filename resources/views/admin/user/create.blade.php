                            ...
                            <form action="{{route('users.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6 my-3" style="margin-top: 23px!important">
                                            <div class="form-floating">
                                                <input type="text" class="form-control @error('phone') is-invalid @enderror" value="{{old('phone') ? old('phone') : $data->phone}}" id="phone" name="phone" placeholder="Enter Phone" onkeypress="return isNumberKey(event)" maxlength="10" minlength="10" required>
                                        ...
                                        <div class="col-sm-6 my-3" style="margin-top: 23px!important">
                                            <div class="form-floating">
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" value="{{old('email') ? old('email') : $data->email}}" id="email" name="email" placeholder="Enter Email" required>
                                        ...
                                        <div class="col-sm-6 my-3" style="margin-top: 23px!important">
                                            <div class="form-floating">
                                                <input type="text" class="form-control @error('password') is-invalid @enderror" value="{{old('password') ? old('password') : ''}}" id="password" name="password" placeholder="Enter Password">
